...
public:
  ...
  friend String operator+(String lhs, unsigned int rhs) {
    lhs += rhs;
    return lhs;
  }
  friend String operator+(String lhs, long rhs) {
    lhs += rhs;
    return lhs;
  }
  friend String operator+(String lhs, unsigned long rhs) {
    lhs += rhs;
    return lhs;
  }
  friend String operator+(String lhs, float rhs) {
    lhs += rhs;
    return lhs;
  }
  friend String operator+(String lhs, double rhs) {
    lhs += rhs;
    return lhs;
  }
